...
//Macro function: Get the low 8 bits of A (宏函数 获得A的低八位)
#define GET_HIGH_BYTE(A) (uint8_t)((A) >> 8)
//Macro function: Get the high 8 bits of A (宏函数 获得A的高八位)
#define BYTE_TO_HW(A, B) ((((uint16_t)(A)) << 8) | (uint8_t)(B))
//Macro function: Combine A as high byte and B as low byte into a 16-bit integer (宏函数 以A为高八位 B为低八位 合并为16位整形)
